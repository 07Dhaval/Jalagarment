...
const Home = () => {
  ...
  const categories = [
    {
      name: "MEN'S WEAR",
      img: "/assets/men-category.png",
      path: "/catalog?category=Men's Wear",
    },
    {
      name: "WOMEN'S WEAR",
      img: "/assets/women-category.png",
      path: "/catalog?category=Women's Wear",
    },
    {
      name: "KID'S WEAR",
      img: "/assets/kids-category.png",
      path: "/catalog?category=Kids Wear",
    },
  ];
  ...
  const displayBestSellers = [...featuredProducts, ...otherProducts].slice(
    0,
    8,
  );
    ...
    >
      ...
      <section className="hero-section">
        ...
        <div className="container hero-container">
          ...
          >
            <span className="hero-subtitlee">
              PREMIUM TEXTILE EXPORTS SINCE 2010
            </span>
            <h1 className="hero-title">JALAGARMENT</h1>
            <p className="hero-description">
              Quality garments for global markets. Trusted by 500+ clients
              across 25+ countries.
            </p>
              ...
              displayBestSellers.map((product, index) => (
                ...
                >
                  ...
                  <div className="best-seller-info">
                    <h3>{product.name}</h3>
                    <span className="best-seller-cat">
